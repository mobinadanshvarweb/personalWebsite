const Button = ({ text, mode }: { text: string; mode: boolean }) => {
  return (
    <button className="group transition-all  duration-500 overflow-hidden relative w-46 px-6 py-7 flex justify-center items-center text-white bg-[#767676] font-medium uppercase">
      <span
